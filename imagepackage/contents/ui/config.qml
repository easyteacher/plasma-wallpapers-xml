...
ColumnLayout {
    ...
    Wallpaper.ImageBackend {
        id: imageWallpaper
        renderingMode: (configDialog.currentWallpaper === "com.github.easyteacher.plasma.wallpapers.xml") ? Wallpaper.ImageBackend.SingleImage : Wallpaper.ImageBackend.SlideShow
        targetSize: {
    ...
    Component {
        ...
        Item {
            property var imageModel: (configDialog.currentWallpaper === "com.github.easyteacher.plasma.wallpapers.xml") ? imageWallpaper.wallpaperModel : imageWallpaper.slideFilterModel
            ...
            KCM.SettingHighlighter {
                ...
                highlight: configDialog.currentWallpaper === "com.github.easyteacher.plasma.wallpapers.xml" && cfg_Image != cfg_ImageDefault
            }
        }
    }
    ...
    DropArea {
        ...
        Loader {
            anchors.fill: parent
            sourceComponent: (configDialog.currentWallpaper == "com.github.easyteacher.plasma.wallpapers.xml") ? thumbnailsComponent :
                ((configDialog.currentWallpaper == "com.github.easyteacher.plasma.wallpapers.xml.slideshow") ? slideshowComponent : undefined)
        }
    }
    ...
    RowLayout {
        ...
        visible: configDialog.currentWallpaper == "com.github.easyteacher.plasma.wallpapers.xml"
        QtControls2.Button {
            icon.name: "list-add"
