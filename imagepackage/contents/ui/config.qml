...
ColumnLayout {
    ...
    PlasmaWallpaper.ImageBackend {
        id: imageWallpaper
        renderingMode: (configDialog.currentWallpaper === "com.github.easyteacher.plasma.wallpapers.xml") ? PlasmaWallpaper.ImageBackend.SingleImage : PlasmaWallpaper.ImageBackend.SlideShow
        targetSize: {
    ...
    DropArea {
        ...
        Loader {
            anchors.fill: parent
            source: (configDialog.currentWallpaper == "com.github.easyteacher.plasma.wallpapers.xml") ? "ThumbnailsComponent.qml" :
                ((configDialog.currentWallpaper == "com.github.easyteacher.plasma.wallpapers.xml.slideshow") ? "SlideshowComponent.qml" : "")
        }
    }
