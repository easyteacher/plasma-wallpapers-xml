...
Item {
    ...
    readonly property var imageModel: (configDialog.currentWallpaper === "com.github.easyteacher.plasma.wallpapers.xml") ? imageWallpaper.wallpaperModel : imageWallpaper.slideFilterModel
